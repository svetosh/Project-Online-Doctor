...
%    список_симптомов(["гипертония","отек на двух ногах","кашель","насморк","высокая температура", "отёчность лица", "расширение поверхностных вен нижних конечностей у пациента или в семейном намнезе","отек на одной ноге","принимает препараты из группы БКК","отеки постоянные/не проходят после сна и отдыха"]).
