...
гастроэнтеролог(Симптомы, "гастроэнтеролог"):-
	заболевание_для_гастроэнтеролога(Симптомы).
	
гинеколог(Симптомы, "гинеколог"):-
	заболевание_для_гинеколога(Симптомы).

уролог(Симптомы, "уролог"):-
	заболевание_для_уролога(Симптомы).

скорая(Симптомы, "скорая помощь"):-
...
назначить_raw(Симптомы, Врачи):-
	...
	гастроэнтеролог(Симптомы, Врачи);
	гинеколог(Симптомы, Врачи);
	уролог(Симптомы, Врачи);
	скорая(Симптомы, Врачи);
